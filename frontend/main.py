...
"""LifeOS AI UI frontend — thin FastAPI proxy to the ADK backend.

Serves the approval HTML and queries the backend's built-in ADK session
APIs to find goals pending user approval:
...
# Minimum effort amount that triggers the review path.
REVIEW_THRESHOLD = 100

STATIC_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "static")

app = FastAPI(title="LifeOS AI Dashboard UI")
